      ...
      new QueryClient({
        defaultOptions: {
          queries: {
            ...
            /**
             * ٣٠ ثانية لا خمس دقائق.
             *
             * الخمس دقائق كانت تمنع إعادة الجلب العبثية عند كل إعادة
             * تركيب، لكنها جعلت أي تعديل في لوحة التحكم يتأخّر ظهوره
             * على الموقع بقدرها. ثلاثون ثانية تكفي لمنع الطلبات
             * المتلاحقة وتُبقي التعديلات شبه فورية.
             */
            staleTime: 30 * 1000,
          },
        },
