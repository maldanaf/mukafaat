...
function PrivacyPolicyPage() {
  ...
  const fallbackContent = isRTL
    ? `<p>أحد أولوياتنا الرئيسية في منصة مكافئات هو حماية خصوصية زوارنا، وتحتوي وثيقة سياسة الخصوصية هذه على أنواع المعلومات التي يتم جمعها وتسجيلها من قبل منصة مكافئات وكيفية استخدامنا لها.</p>
<p>إذا كان لديك أسئلة إضافية أو تحتاج إلى مزيد من المعلومات حول سياسة الخصوصية الخاصة بنا، فلا تتردد في الاتصال بنا.</p>
<p>تنطبق سياسة الخصوصية هذه فقط على أنشطتنا عبر الإنترنت، وتشمل زوار موقعنا الإلكتروني فيما يتعلق بالمعلومات التي شاركوها و/أو نجمعها في منصة مكافئات. لا تنطبق هذه السياسة على أي معلومات يتم جمعها خارج الإنترنت أو عبر قنوات أخرى غير هذا الموقع الإلكتروني.</p>
<h3>الموافقة</h3>
...
<li>Find something and prevent fraud</li>
  ...
  const pageTitle = page?.title || (isRTL ? "سياسة الخصوصية - مكافئات" : `${t("home.footer.privacy")} - Mukafaat`);
