...
function TermsConditionsPage() {
  ...
  const fallbackContent = isRTL
    ? `<p>مرحباً بك في منصة مكافئات. تحكم هذه الشروط والأحكام استخدامك لموقعنا الإلكتروني وخدماتنا. من خلال الوصول إلى موقعنا الإلكتروني واستخدامه، فإنك تقبل وتوافق على الالتزام بهذه الشروط والأحكام.</p>
...
<p>يُمنح الإذن لتحميل نسخة واحدة مؤقتة من المواد (المعلومات أو البرامج) على موقع منصة مكافئات الإلكتروني للعرض الشخصي غير التجاري المؤقت فقط.</p>
...
<p>ستنتهي هذه الرخصة تلقائياً إذا انتهكت أي من هذه القيود ويمكن إنهاؤها من قبل منصة مكافئات في أي وقت.</p>
<h3>إخلاء المسؤولية</h3>
<p>يتم تقديم المواد على موقع منصة مكافئات الإلكتروني على أساس 'كما هي'. لا تقدم منصة مكافئات أي ضمانات، صريحة أو ضمنية، وتتنصل وتنفي جميع الضمانات الأخرى بما في ذلك على سبيل المثال لا الحصر:</p>
<ul>
...
<li>Compatibility with all devices and browsers</li>
  ...
  const pageTitle = page?.title || (isRTL ? "الشروط والأحكام - مكافئات" : `${t("home.footer.terms")} - Mukafaat`);
